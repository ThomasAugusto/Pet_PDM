...
public class RacaAdapter extends RecyclerView.Adapter<RacaAdapter.ViewHolder> {
    List<ListagemRacaActivity> listraca;
    Context context;
    DB_Racas db_racas;

    public RacaAdapter(List<ListagemRacaActivity> listraca, Context context) {
        this.listraca = listraca;
        this.context = context;
        db_racas = new DB_Racas(context);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final ListagemRacaActivity listagemRacaActivity = listraca.get(position);
